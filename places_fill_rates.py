...
columns_to_keep = ["country", "iso_country_code", "placekey", "parent_placekey",\
                   ...
                   "open_hours", "category_tags", "open_on", "closed_on", "tracking_closed_since", "geometry_type", "Pct with domains","Pct with website", "Pct with booking links"]
...
fill_rates_df.rename(columns={"country": "Country", "iso_country_code": "ISO Country Code","Pct with domains": "domains" ,"Pct with website": "website", "Pct with booking links":"booking_link"}, inplace=True)
